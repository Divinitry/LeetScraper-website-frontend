    ...
    <div>
      <div>
        <div className="flex flex-col text-center max-w-5xl mx-auto pt-40">
          ...
          <p className="mt-6 text-lg text-gray-200 text-center max-w-3xl mx-auto animate-fade-in opacity-0 [animation-delay:400ms] -translate-y-4 pb-10">
          ...
          <button onClick={() => navigate('/search')} className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none mx-auto">

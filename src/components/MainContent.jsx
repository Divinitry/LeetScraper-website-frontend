    ...
    <div>
      <div>
        <div className="flex flex-col text-center max-w-5xl mx-auto pt-36 md:pt-52">
          <h1 className="animate-fade-in text-3xl font-bold sm:text-4xl md:text-6xl opacity-0 [animation-delay:200ms] -translate-y-4">
          ...
          <p className="mt-6 sm:mt-10 text-base sm:text-lg md:text-xl text-gray-400 text-center max-w-3xl mx-auto animate-fade-in opacity-0 [animation-delay:400ms] -translate-y-4 pb-6 sm:pb-10">
            ...
            personalized notes and resources, and built-in code terminal—
            designed to help you conquer every challenge.
          </p>
      ...
      <div className="w-full md:w-5/6 lg:w-3/4 relative overflow-hidden rounded-xl border border-gray-800 p-[1px] my-16 sm:my-36 mx-auto shadow-custom-purple">
        <span className="absolute inset-[-1000%] animate-[spin_2s_linear_infinite] bg-[conic-gradient(from_90deg_at_50%_50%,#E2CBFF_0%,#393BB2_50%,#E2CBFF_100%)]" />
        <div className="flex flex-col lg:flex-row h-auto sm:h-[500px] w-full items-center justify-center rounded-xl bg-black px-3 py-6 sm:py-1 text-sm font-medium text-gray-50 backdrop-blur-3xl">
          <div className="p-6 sm:p-16 lg:w-1/2 flex flex-col justify-center text-start overflow-y-auto">
            <h1 className="text-2xl sm:text-4xl">Search for your Leetcode problem</h1>
      ...
      <div className="w-full md:w-5/6 lg:w-3/4 relative overflow-hidden rounded-xl border border-gray-800 p-[1px] my-16 sm:my-36 mx-auto shadow-custom-purple">
        ...
        <div className="flex flex-col lg:flex-row h-auto sm:h-[500px] w-full items-center justify-center rounded-xl bg-black px-3 py-6 sm:py-1 text-sm font-medium text-gray-50 backdrop-blur-3xl">
          <div className="p-6 sm:p-16 lg:w-1/2 flex flex-col justify-center text-start overflow-y-auto">
            <h1 className="text-2xl sm:text-4xl">Code using our built-in IDE.</h1>
            <p className="pt-6 sm:pt-10 text-sm sm:text-xl text-gray-400">
      ...
      <div className="w-full md:w-5/6 lg:w-3/4 relative overflow-hidden rounded-xl border border-gray-800 p-[1px] my-16 sm:my-36 mx-auto shadow-custom-purple">
        ...
        <div className="flex flex-col lg:flex-row h-auto sm:h-[500px] w-full items-center justify-center rounded-xl bg-black px-3 py-6 sm:py-1 text-sm font-medium text-gray-50 backdrop-blur-3xl">
          <div className="p-6 sm:p-16 lg:w-1/2 flex flex-col justify-center text-start overflow-y-auto">
            <h1 className="text-2xl sm:text-4xl">Instant feedback with statistics</h1>
            <p className="pt-6 sm:pt-10 text-sm sm:text-xl text-gray-400">

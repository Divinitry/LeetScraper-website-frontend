...
const Header = ({ isLoggedIn }) => {
  ...
  return (
    <header
      className="fixed top-0 left-0 w-full z-50 border-b bg-black"
    ...
    >
      <div className="container mx-auto flex flex-col lg:flex-row lg:items-center px-4 py-7 relative">
        <div className="flex items-center justify-start w-full lg:w-auto">
          <a
            href="/"
            className="flex items-center whitespace-nowrap text-2xl font-black text-white"
          >
        ...
        <nav
          ...
          className="peer-checked:pt-8 peer-checked:max-h-60 flex max-h-0 w-full flex-col items-center overflow-hidden transition-all lg:max-h-full lg:flex-row lg:flex-1 lg:justify-center relative"
        >
          <ul className="flex w-full flex-col items-center space-y-2 lg:flex-row lg:justify-center lg:space-y-0 space-x-6">
            <li className="">
              <a
        ...
        <div
          className={`absolute top-0 right-0 flex items-center h-full transition-all duration-300 ${
            windowWidth < 1024 ? "mr-20" : "ml-0"
          }`}
        >
          {isLoggedIn ? (
            <a
